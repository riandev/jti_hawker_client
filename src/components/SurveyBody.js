...
const SurveyBody = () => {
  ...
  const handleSearch = () => {
    fetch(`http://192.168.10.11:5051/dMatched/${searchNumber}`)
      .then((res) => res.json())
  ...
  const handleSubmit = (e) => {
    ...
    fetch(`http://192.168.10.11:5051/answers/${consumer?._id}`, {
      method: "PATCH",
    ...
    <div>
      ...
      >
        * আপনার অবগতির জন্য জানানো যাচ্ছে যে কলটি রেকর্ড করা হচ্ছে এবং আপনার
        অনুমতি নেওয়া হচ্ছে যে আপনার ব্যাক্তিগত তথ্য সংরক্ষণ করা হবে যা ভবিষ্যতে
      ...
      >
        ...
        <Form.Group onChange={q10value} as={Row}>
          <Form.Control as="select" className="w-50 ml-3">
            ...
            <option value="2_4stick">২-৪ শলাকা</option>
