...
const DownloadReport = () => {
  ...
  const handleReport = () => {
    fetch(`http://192.168.10.12:5051/getBRReport/${reportDate}`)
      .then((res) => res.json())
      .then((data) => setBRReport(data));
    fetch(`http://192.168.10.12:5051/getTerritoryReport/${reportDate}`)
      .then((res) => res.json())
      .then((data) => setTerritoyReport(data));
    fetch(`http://192.168.10.12:5051/getAreaReport/${reportDate}`)
      .then((res) => res.json())
      .then((data) => setAreaReport(data));
    fetch(`http://192.168.10.12:5051/getRegionReport/${reportDate}`)
      .then((res) => res.json())
